...
/**
 * 爬图片 Created by gz on 2017/11/29.
 */
@Component
public class GetImage {
	...
	public void Download(List<String> listImgSrc, String dir) {
		try {
			// 开始时间
			...
			for (String url : listImgSrc) {
				...
				FileOutputStream fo = new FileOutputStream(new File(dir + imageName));// 文件输出流
