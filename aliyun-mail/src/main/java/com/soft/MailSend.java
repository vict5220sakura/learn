...
public class MailSend {
	...
	private static final String EMAIL_OWNER_ADDR = "vict5220ABC";
	private static final String EMAIL_OWNER_ADDR_PASS = "";
	...
	public static void main(String[] args) throws MessagingException {
		...
		sendMail("asdasd", "vict5220@163.com", "spring boot 邮件测试");
	}
}
