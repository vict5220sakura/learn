...
public class TalkUtil {
	private final String APIURL = "https://api.ai.qq.com/fcgi-bin/nlp/nlp_textchat";
	private final String APIKEY = "3b0TsY8DvNGC0h4c";
	private final String APIID = "2108614417";
	
	@Autowired
	private RestTemplate restTemplate;
	public Optional<String> talk(String question,String session) throws IOException{
